#### TicTacToe---Java
Built using Java8 &amp; javaFx


This is just a simple **Tic Tac Toe game** i made using Java 8. For now it **doesn't** have AI and it only support **player vs player** mode.
